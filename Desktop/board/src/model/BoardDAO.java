...
public class BoardDAO {
    ...
    public void insertBoard(BoardBean bean){
        ...
        int ref=0;//글그룹을 의미 = 쿼리를 실행시켜서 가장 큰 ref값을 가져온후 +1을 더해주면 됨
    ...
    public Vector<BoardBean> getAllBoard(int start, int end){
        ...
        try{
            ...
            while(rs.next()){
                //데이터를 패키징(가방 = Boardbean 클래스를 이용)해서 패키징
    ...
    public void reWriteBoard(BoardBean bean){
        ...
        try{
            ////////핵심 코드/////////
              //부모 글보다 큰 re_level이 값을 전부 1씩 증가시켜줌
    ...
    public BoardBean getOneUpdateBoard(int num){
        ...
        try{
            ...
            if(rs.next()){
                ...
                bean.setNum(rs.getInt(7));
                bean.setNum(rs.getInt(8));
                bean.setNum(rs.getInt(9));
                bean.setNum(rs.getInt(10));
            }
        }catch(Exception e){
            e.printStackTrace();
        }
