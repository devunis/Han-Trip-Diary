        ...
        <a href="BoardList.jsp? pageNum = <%=startPage-10%>">[이전]<a/>
            <%
                ...
                for(int i=startPage; i<=endPage; i++ ){
                    %>
            <a href="BoardListjsp?pageNum=<%=i%>">[<%=i%>]</a>
            <%
                }
                //다음이라는 링크를 만들건지 파악
                if(endPage < pageCount){
                    %>
            <a href="BoardListjsp?pageNum=<%=startPage +10%>">[다음]</a>
                <%
                }
            }
        %>
